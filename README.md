...
- дашборды и алерты для мониторинга
- SRE-дежурные
- инструменты быстрого отката до последней безопасной версии
- L7-балансировка, API-Gateway
- прокси-сервер с защитой от аттак
- запланированные отключения серверов
- лимит на выполнение запроса, дабы не обслуживать долгие запросы
