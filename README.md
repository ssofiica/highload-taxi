...
66% пользователей Яндекс Такси из России, значит каждый из 3 российских ДЦ будет обслуживать 880к пользователей в день с нагрузкой на 11к rps.<br>
Остальные страны обслуживает 3 ДЦ, на них приходится 440к пользователей в день с нагрузкой 5,5к.<br>

### Схема DNS балансировки

Для балансировки можно использовать Geo-based DNS, так как расположение серверов обусловлено географией, в случае увеличения запросов и количества ЦД можно рассмотреть Latency-based DNS

### Схема Anycast балансировки

Яндекс имеет ЦД в Калужской, Рязанской областях, так что для центральной России, на которую приходится большая часть запросов, можно использовать BGP Anycast
