...
3. RPS в разбивке по типам запросов (запросов в секунду) - для основных запросов
  600к запросов в секунду [^6]
  10 000 rps динамический расчет цены поездки [^7]
...
[^6] (https://dev.go.yandex/blog/yandex-taxi-reliability-2024-05-30)
[^7] (https://dev.go.yandex/blog/dynamic-pricing-platform-2024-06-15)
[^8] (https://dev.to/karanpratapsingh/system-design-uber-56b1)
