...
| Таблица             | Размер одной строки, байт | Кол-во записей | Объем | Чтение, Кбит/с | Запись, Кбит/с |
|---------------------|---------------------------|----------------|-------|--------|--------|
...
| *demand*            |*148* | *8 млрд+?* | ** | *115* | *115* |
| *proposal*          |*128* | *8 млрд+?* | ** | *66* | *82* |
...
Таблица Ride довольна велика,  по полю started_at, потом удалять партиции. То же самые с таблицей geoposition
### Репликация
