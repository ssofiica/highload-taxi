...
| PostgreSQL | Отказоустойчивость обеспечивается автоматическим переключением ролей узлов кластера с помощью [Patroni](https://postgrespro.ru/clusters/patroni), WAL обеспечивает восстановление в случае сбоев[^9]<br> Дифференциальное резервное копирование[^10]|
